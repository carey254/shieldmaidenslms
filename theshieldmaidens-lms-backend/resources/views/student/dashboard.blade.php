...
<head>
    ...
    <title>Student Dashboard - The Shield Maidens LMS</title>
        ...
        <div class="px-4 py-6 sm:px-0">
            <div class="border-4 border-dashed border-gray-200 rounded-lg h-96 flex items-center justify-center">
                <div class="text-center">
                    ...
                    <h2 class="text-2xl font-bold text-gray-900 mb-2">Welcome, Student!</h2>
                    <p class="text-gray-600">This is your student dashboard.</p>
