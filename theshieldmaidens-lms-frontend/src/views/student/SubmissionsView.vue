...
const faqs = ref<FAQ[]>([
  ...
  },
  {
    ...
    answer: 'Common formats include PDF, DOC, DOCX for documents, and JPG, PNG for images. Check specific assignment requirements for accepted formats.',
    open: false
  },
  {
    question: 'When are assignments due?',
    answer: 'Due dates are displayed on each assignment card and in your course calendar. You\'ll receive notifications 24 hours before deadlines.',
    open: false
  }
])
